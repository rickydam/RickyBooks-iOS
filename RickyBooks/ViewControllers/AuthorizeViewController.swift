...
class AuthorizeViewController: UIViewController {
    ...
    @IBAction func registerSubmitPressed(_ sender: Any) {
        ...
        register(tabBarController: self.tabBarController!, nameInput: nameInput, emailInput: emailInput, passwordInput: passwordInput, confirmPasswordInput: confirmPasswordInput)
    }
    ...
    @IBAction func loginSubmitPressed(_ sender: Any) {
        ...
        login(tabBarController: self.tabBarController!, emailInput: emailInput, passwordInput: passwordInput)
    }
